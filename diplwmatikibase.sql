...
-- Dumping database structure for heroku_f7049074a296508
DROP DATABASE IF EXISTS `heroku_f7049074a296508`;
CREATE DATABASE IF NOT EXISTS `heroku_f7049074a296508` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `heroku_f7049074a296508`;

-- Dumping structure for table heroku_f7049074a296508.actors
...
-- Dumping data for table heroku_f7049074a296508.actors: ~10 rows (approximately)
...
REPLACE INTO `actors` (`idactor`, `name`, `surname`, `birthDate`, `isPlayed`) VALUES
	...
	(6, 'name6', 'surname6', '1994-02-02 00:00:00', 1),
	...
	(11, 'name1', 'surname11', '1999-02-02 00:00:00', 0);
/*!40000 ALTER TABLE `actors` ENABLE KEYS */;

-- Dumping structure for table heroku_f7049074a296508.excersice_tables
...
-- Dumping data for table heroku_f7049074a296508.excersice_tables: ~2 rows (approximately)
...
-- Dumping structure for table heroku_f7049074a296508.fill_fields_questions
...
CREATE TABLE IF NOT EXISTS `fill_fields_questions` (
  ...
  `fill_field_question` varchar(200) COLLATE utf8_bin NOT NULL,
  `hideWord` varchar(100) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table heroku_f7049074a296508.fill_fields_questions: ~30 rows (approximately)
...
-- Dumping structure for table heroku_f7049074a296508.movies
...
-- Dumping data for table heroku_f7049074a296508.movies: ~9 rows (approximately)
...
REPLACE INTO `movies` (`idmovie`, `title`, `releasedDate`, `idActor`) VALUES
	...
	(8, 'title8', NULL, 5),
	(9, 'title9', '1994-06-06 00:00:00', NULL),
	(10, 'title10', '2000-02-02 00:00:00', 9),
	(11, 'title11', '2021-02-02 00:00:00', NULL);
/*!40000 ALTER TABLE `movies` ENABLE KEYS */;

-- Dumping structure for table heroku_f7049074a296508.score_table
...
-- Dumping data for table heroku_f7049074a296508.score_table: ~6 rows (approximately)
...
REPLACE INTO `score_table` (`id`, `student_id`, `score`, `time`, `category`, `difficulty`, `created_at`, `updated_at`) VALUES
	...
	(235, 5, 134, '00:00:58', '15 Questions', 'hard', '2021-06-01 23:49:50', '2021-06-01 23:49:50'),
	(245, 23, 124, '00:00:55', '15 Questions', 'hard', '2021-06-03 19:34:07', '2021-06-03 19:34:07'),
	(255, 23, 196, '00:01:45', '25 Questions', 'hard', '2021-06-03 19:45:26', '2021-06-03 19:45:26');
/*!40000 ALTER TABLE `score_table` ENABLE KEYS */;

-- Dumping structure for table heroku_f7049074a296508.sql_questions
...
CREATE TABLE IF NOT EXISTS `sql_questions` (
  ...
  `correct_answer` varchar(50) COLLATE utf8_bin NOT NULL,
  `score` int(11) NOT NULL,
  `difficulty` varchar(50) COLLATE utf8_bin NOT NULL,
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table heroku_f7049074a296508.sql_questions: ~53 rows (approximately)
...
-- Dumping structure for table heroku_f7049074a296508.sql_random_queries
...
) ENGINE=InnoDB AUTO_INCREMENT=2465 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table heroku_f7049074a296508.sql_random_queries: ~30 rows (approximately)
...
REPLACE INTO `sql_random_queries` (`id`, `sql_query`, `hideWord`, `table_id`) VALUES
	...
	(1867, 'SELECT COUNT(isPlayed), idactor FROM actors GROUP BY idactor ORDER BY COUNT(idactor) DESC', 'ORDER BY,DESC', 249),
	...
	(1871, 'SELECT * FROM actors WHERE birthDate IS NULL', 'IS NULL', 249),
...
-- Dumping structure for table heroku_f7049074a296508.sql_random_queries_true_or_false
...
) ENGINE=InnoDB AUTO_INCREMENT=1345 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table heroku_f7049074a296508.sql_random_queries_true_or_false: ~30 rows (approximately)
...
REPLACE INTO `sql_random_queries_true_or_false` (`id`, `sql_query_true_or_false`, `exersice_table_id`) VALUES
	...
	(737, 'SELECT name FROM actors WHERE idactor=3', 249),
	(738, 'SELECT MIN(idactor) FROM actors', 249),
	(739, 'SELECT COUNT(idactor) FROM actors', 249),
	(740, 'SELECT AVG(idactor) FROM actors WHERE idactor>5', 249),
	(741, 'SELECT SUM(idactor) FROM actors WHERE idactor>5', 249),
	(742, 'SELECT idactor FROM actors WHERE NOT idactor>2', 249),
...
-- Dumping structure for table heroku_f7049074a296508.success_rate
...
-- Dumping data for table heroku_f7049074a296508.success_rate: ~7 rows (approximately)
...
REPLACE INTO `success_rate` (`id`, `id_student`, `rate`, `time`, `table_name`, `created_at`, `updated_at`, `type_excersice`) VALUES
	(135, 5, 'Σωστές 12 στις 20', '00:00:59', 'actors', '2021-06-01 23:54:16', '2021-06-01 23:54:16', 'Σωστό-λάθος σε 1 πίνακα'),
	(145, 5, 'Σωστές 5 στις 10', '00:00:38', 'movies', '2021-06-02 19:32:13', '2021-06-02 19:32:13', 'Σωστό-λάθος σε 2 πίνακες'),
	(155, 5, 'Σωστές 18 στις 20', '00:01:46', 'actors', '2021-06-02 19:34:52', '2021-06-02 19:34:52', 'Σωστό-λάθος σε 1 πίνακα'),
	(165, 5, 'Σωστές 6 στις 10', '00:01:19', 'movies', '2021-06-02 19:36:24', '2021-06-02 19:36:24', 'Συμπλήρωση-κενού σε 2 πίνακες'),
	(175, 23, 'Σωστές 20 στις 20', '00:01:18', 'actors', '2021-06-03 19:41:19', '2021-06-03 19:41:19', 'Συμπλήρωση-κενού σε 1 πίνακα'),
	(185, 23, 'Σωστές 10 στις 10', '00:00:41', 'movies', '2021-06-03 19:42:08', '2021-06-03 19:42:08', 'Συμπλήρωση-κενού σε 2 πίνακες'),
	(195, 23, 'Σωστές 10 στις 20', '00:00:44', 'actors', '2021-06-03 19:42:58', '2021-06-03 19:42:58', 'Σωστό-λάθος σε 1 πίνακα'),
	(205, 23, 'Σωστές 4 στις 10', '00:00:17', 'movies', '2021-06-03 19:43:22', '2021-06-03 19:43:22', 'Σωστό-λάθος σε 2 πίνακες');
/*!40000 ALTER TABLE `success_rate` ENABLE KEYS */;

-- Dumping structure for table heroku_f7049074a296508.user_table
...
CREATE TABLE IF NOT EXISTS `user_table` (
  ...
  `verification_code` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `username_UNIQUE` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table heroku_f7049074a296508.user_table: ~7 rows (approximately)
/*!40000 ALTER TABLE `user_table` DISABLE KEYS */;
REPLACE INTO `user_table` (`id`, `first_name`, `last_name`, `sex`, `phone`, `email`, `username`, `password`, `role`, `verification_code`) VALUES
	(3, 'Dimitris', 'Motsios', 'male', '6395612353', 'www.motsios@hotmail.com', 'motsios', '$2a$10$CGrMW2DrrQJn8NBmcpdVHOUe9nYaA9Z7QnJgq4TofR1ZYbN6lmeUe', 'teacher', ''),
	...
	(23, 'Georgia', 'Kalli', 'female', '6932569515', 'georgia@gmail.com', 'georgia', '$2a$10$jGKcviqvwK3RqFy/kmUvfe3ofLmHU2HiYQw1G0uWjh.8ItYqZB7G.', 'student', NULL),
